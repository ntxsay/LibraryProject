            ...
            try
            {
                ...
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    foreach (IRange row in worksheet.Rows)
                    {
                        ...
                        //var charsFirstColumn = row.Columns[0].AddressLocal.ToCharArray().ToList();
                        //for (int y = 0; y < charsFirstColumn.Count; y++)
                        //{
                        //    var charc = charsFirstColumn[y];
                        //    if (!char.IsNumber(charc))
                        //    {
                        //        charsFirstColumn.Remove(charc);
                        //        y = 0;
                        //        continue;
                        //    }
                        //}
                        //string firstColumnNumber = new string(charsFirstColumn.ToArray());

                        //var charsLastColumn = row.Columns[row.Columns.Length - 1].AddressLocal.ToCharArray().ToList();
                        //for (int y = 0; y < charsLastColumn.Count; y++)
                        //{
                        //    var charc = charsLastColumn[y];
                        //    if (!char.IsNumber(charc))
                        //    {
                        //        charsLastColumn.Remove(charc);
                        //        y = 0;
                        //        continue;
                        //    }
                        //}
                        //string lastColumnNumber = new string(charsLastColumn.ToArray());

                        //int firstColumn = Convert.ToInt32(firstColumnNumber);
                        //int lastColumn = Convert.ToInt32(lastColumnNumber);
