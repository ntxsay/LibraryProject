...
namespace LibraryProjectUWP.Views.Author
{
    public sealed partial class NewEditAuthorUC : PivotItem
    {
        public readonly ManageAuthorParametersDriverVM _parameters;

        public NewEditAuthortUCVM ViewModelPage { get; set; } = new NewEditAuthortUCVM();

        public delegate void CancelModificationEventHandler(NewEditAuthorUC sender, ExecuteRequestedEventArgs e);
        public event CancelModificationEventHandler CancelModificationRequested;

        public delegate void UpdateItemEventHandler(NewEditAuthorUC sender, ExecuteRequestedEventArgs e);
        public event UpdateItemEventHandler UpdateItemRequested;

        public delegate void CreateItemEventHandler(NewEditAuthorUC sender, ExecuteRequestedEventArgs e);
        public event CreateItemEventHandler CreateItemRequested;
        public NewEditAuthorUC()
        {
            this.InitializeComponent();
        }

        public NewEditAuthorUC(ManageAuthorParametersDriverVM parameters)
        {
            this.InitializeComponent();
    ...
    public class NewEditAuthortUCVM : INotifyPropertyChanged
    {
