...
{
    internal class ContactCollectionCommonViewVM
    {
        readonly ContactCollectionPage _parentPage;
        readonly ContactCollectionGdViewPage _collectionGridViewPage;
        readonly LibraryCollectionDataGridViewPage _collectionDataGridViewPage;

        public ContactCollectionCommonViewVM(ContactCollectionGdViewPage libraryCollectionGridViewPage, ContactCollectionPage parentPage)
        {
            _collectionGridViewPage = libraryCollectionGridViewPage;
            _parentPage = parentPage;
        }

        public ContactCollectionCommonViewVM(LibraryCollectionDataGridViewPage libraryCollectionDataGridViewPage, ContactCollectionPage parentPage)
        {
            _collectionDataGridViewPage = libraryCollectionDataGridViewPage;
            _parentPage = parentPage;
        }
        ...
        internal void EditLibrary(BibliothequeVM viewModel)
        {
            try
            {
                ...
                if (_collectionDataGridViewPage != null)
                {
                    _collectionDataGridViewPage.ViewModelPage.SplitViewContent = userControl;
                    _collectionDataGridViewPage.ViewModelPage.IsSplitViewOpen = true;
                }
                else if (_collectionGridViewPage != null)
                {
                    _collectionGridViewPage.ViewModelPage.SplitViewContent = userControl;
                    _collectionGridViewPage.ViewModelPage.IsSplitViewOpen = true;
                }
            }
            catch (Exception ex)
            {
        ...
        private async void NewEditLibraryUC_UpdateItemRequested(NewEditLibraryUC sender, ExecuteRequestedEventArgs e)
        {
            ...
            try
            {
                ...
                if (_collectionDataGridViewPage != null)
                {
                    _collectionDataGridViewPage.ViewModelPage.IsSplitViewOpen = false;
                    _collectionDataGridViewPage.ViewModelPage.SplitViewContent = null;
                }
                else if (_collectionGridViewPage != null)
                {
                    _collectionGridViewPage.ViewModelPage.IsSplitViewOpen = false;
                    _collectionGridViewPage.ViewModelPage.SplitViewContent = null;
                }
            }
            catch (Exception ex)
            {
